...
class _MobileBusinessSetupState extends State<_MobileBusinessSetup> {
  int step=0; final data=_MobileStoreSetupData();
  ...
  void _next(){if(step<5){setState(()=>step++);}else{ScaffoldMessenger.of(context).showSnackBar(SnackBar(content:Text('Store setup ready to sync • '+data.storeName),behavior:SnackBarBehavior.floating));}}
}
