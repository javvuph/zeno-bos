                ...
                child: Column(
                  children: [
                    ...
                    ZenoCard(
                      ...
                      child: Column(
                        children: [
                          ZenoDropdown<String>(label: "Primary Location", value: p.warehouseLocation.isEmpty ? null : p.warehouseLocation, items: controller.locationsList.map((e) => DropdownMenuItem(value: e, child: Text(e))).toList(), onChanged: (v) => controller.updateField(warehouseLocation: v), width: ZenoFieldWidth.full),
                          const SizedBox(height: 6),
                          Row(
                            children: [
                    ...
                    ZenoCard(
                      ...
                      child: Column(
                        children: [
                          Row(
                            children: [
                              Expanded(child: ZenoDropdown<String>(label: "Primary Supplier", value: p.supplier.isEmpty ? null : p.supplier, items: controller.suppliersList.map((e) => DropdownMenuItem(value: e, child: Text(e))).toList(), onChanged: (v) => controller.updateField(supplier: v))),
                              const SizedBox(width: 8),
                          ...
                          const SizedBox(height: 6),
                          ZenoDropdown<String>(label: "Secondary Supplier", value: p.secondarySupplier.isEmpty ? null : p.secondarySupplier, items: controller.suppliersList.map((e) => DropdownMenuItem(value: e, child: Text(e))).toList(), onChanged: (v) => controller.updateField(secondarySupplier: v), width: ZenoFieldWidth.full),
                        ],
                      ),
                    ),
                    const SizedBox(height: 10),
                    ZenoCard(
                      ...
                      child: Column(
                        children: [
                          Row(
                            children: [
                              Expanded(child: ZenoDropdown<String>(label: "Pack UOM", value: p.purchaseUnit, items: ["Case", "Pallet", "Pouch"].map((e) => DropdownMenuItem(value: e, child: Text(e))).toList(), onChanged: (v) => controller.updateField(purchaseUnit: v))),
                              const SizedBox(width: 8),
