...
## Current Active Version: `version-2`

### Version Lock Status:
- **Git Tag**: `version-2`
- **Locked Date**: September 11, 2026
- **Branch**: `main`

### Restoring Version 2:
To restore the codebase to `version-2` at any time, run:
```bash
git checkout version-2
```
or
```bash
git restore --source=version-2 .
```

---

### Core Specifications Locked in `version-2`:
...
6. **Navigation & Chart Life-cycle Safety**:
